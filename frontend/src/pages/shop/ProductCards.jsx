    ...
    products: PropTypes.arrayOf(
      PropTypes.shape({
        id: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
          .isRequired, // Product ID can be a string or number
        ...
        price: PropTypes.number.isRequired, // Product price must be a number
        oldPrice: PropTypes.number, // Old price is optional
        rating: PropTypes.number.isRequired, // Rating must be a number
      })
    ).isRequired, // Products must be an array and is required
  };