...
const Search = () => {
  ...
  return (
    ...
    <section className="section__container bg-primary-light">
        ...
        <p className="section__subheader">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores,
         molestias aspernatur! Cum repellat dicta beatae!</p>
    </section>

    <section className="section__container">
      <div className="w-full mb-12 flex-col md:flex-row items-center justify-center gap-4">
        <input type="text"
        value={searchQuery}
